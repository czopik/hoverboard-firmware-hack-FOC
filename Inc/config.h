...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PWM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define PRI_INPUT1            3, 0, 0, 1800, 0 // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            3, 0, 0, 1800, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT1            3, 0, 0, 1800, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2            3, 0, 0, 1800, 0 // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
    ...
    #define PRI_INPUT1 3, 0, 0, 1800, 0  // Dla PA8: TYPE, MIN, MID, MAX, DEADBAND.
    #define PRI_INPUT2 3, 0, 0, 1800, 0  // Dla PA10: TYPE, MIN, MID, MAX, DEADBAND.

  #endif

  #define FILTER                  32767 //6553    // 0.1f [-] fixdt(0,16,16) lower value == softer filter [0, 65535] = [0.0 - 1.0].
