...
*/
#define BAT_FILT_COEF           300       // battery voltage filter coefficient in fixed-point. coef_fixedPoint = coef_floatingPoint * 2^16. In this case 655 = 0.01 * 2^16
#define BAT_CALIB_REAL_VOLTAGE  12.00      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           11.9      // adc-value measured by mainboard (value nr 5 on UART debug output)
#define BAT_CELLS               3        // battery number of cells. Normal Hoverboard battery: 10s
